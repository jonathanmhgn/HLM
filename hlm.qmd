---
title: "S13: Mehrebenenmodelle"
author: Jonathan Marienhagen
format: html
page-layout: full
editor: visual
server: shiny
...
fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("b0_sigma", "Standardabweichung des Intercepts über Therapiearten hinweg", min = .01, max = 3, step=0.1, value = .1),
      
      sliderInput("b1_mu", "Mittleres Slope über Therapiearten hinweg", min = -.5, max = .5, step=.1, value = 0),
      sliderInput("b1_sigma", "Standardabweichung des Slopes über Therapiearten hinweg", min = 0, max = 0.2, step=.01, value = 0.01),
